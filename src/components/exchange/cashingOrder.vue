    ...
    <div class="main-container">
        ...
        <span class="dist">
            ...
            <div v-else class="null-list">
                ...
                <p class="tips">（ 如果您添加已新的收货地址，请 <a href="#" @click.prevent="reloadCurPage">刷新</a>此页面~ ）</p>
                    ...
                    <div class="good clearfix">
                        <div class="face">
                            ...
                            <div class="gift-bottom clearfix">
                                ...
                                <p class="G_fl">数量：<span>{{good.defaultNum}}</span></p>
                            </div>
                        </div>
        ...
        <div class="btn-box">
            <div v-show="addlist.length <= 0"><span class="s">( <b>*</b> 必须有选择1个收货地址，如若暂无任何收货地址，请添加一个收货地址~ )</span><button class="disabled">确定兑换</button></div>
            <button v-else @click.prevent="ajaxSubmit">确定兑换</button>
        </div>
    </div>
...
<script>
    ...
    methods:{
        ...
        ajaxSubmit(){
            ...
            query.tel = that.defAddress.telphone;
