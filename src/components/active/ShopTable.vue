<template>
        ...
        <table>
            ...
            <tr v-for="item in arr_items" v-show="$index < pagesize">
                ...
                <td v-if="stats > 0">
                    ...
                    <a href="#" v-if="item.status == 2 || item.status == 4 || item.status == 6"
                       @click.prevent="update(item,$index)">修改</a>
    ...
    <div class="activeinfo" style="display: none;">
        <div class="layer_1">
            ...
            <dl class="clearfix">
                <dt>活动数量：</dt>
                <dd style="position: relative"><input type="number" name="number" v-model="items.number"> <em>辆</em>
                </dd>
...
<style scoped>
    ...
    .G_btn_a:hover, .G_btn_b:hover, .G_btn_c:hover, .G_btn_d:hover, .G_btn_e:hover {
        text-decoration: none;
    }
    ...
    .G_btn_d {
        background: #fff;
        color: #000;
        border: 1px solid #B1B1B1; /*box-shadow: 0px 1px 2px rgba(0,0,0,0.25);*/
    }
    ...
    .G_btn_e {
        background: #FF4242;
        color: #fff;
        border: 1px solid #F00; /*box-shadow: 0px 1px 2px rgba(0,0,0,0.25);*/
    }
